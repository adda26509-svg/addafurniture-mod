...
public class TigerEntity extends AnimalEntity {
    public TigerEntity(EntityType<? extends AnimalEntity> type, World world) { super(type, world); }
    ...
    protected void initGoals() {
        ...
        goalSelector.add(1, new MeleeAttackGoal(this, 1.4, true));
    ...
    @Override
    public boolean isBreedingItem(ItemStack s) { return s.isOf(Items.BEEF); }
    ...
    @Override protected SoundEvent getHurtSound(DamageSource s) { return SoundEvents.ENTITY_CAT_HISS; }
    @Override protected SoundEvent getDeathSound() { return SoundEvents.ENTITY_CAT_DEATH; }
}
