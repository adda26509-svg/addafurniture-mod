...
public class CrocodileEntity extends AnimalEntity {
    public CrocodileEntity(EntityType<? extends AnimalEntity> type, World world) { super(type, world); }
    public static DefaultAttributeContainer.Builder createCrocodileEntityAttributes() {
