...
public class FlamingoEntity extends AnimalEntity {
    public FlamingoEntity(EntityType<? extends AnimalEntity> type, World world) { super(type, world); }
    public static DefaultAttributeContainer.Builder createFlamingoEntityAttributes() {
