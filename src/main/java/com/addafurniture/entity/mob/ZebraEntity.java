...
public class ZebraEntity extends AnimalEntity {
    public ZebraEntity(EntityType<? extends AnimalEntity> type, World world) { super(type, world); }
    public static DefaultAttributeContainer.Builder createZebraEntityAttributes() {
