...
public class GiraffeEntity extends AnimalEntity {
    public GiraffeEntity(EntityType<? extends AnimalEntity> type, World world) { super(type, world); }
    public static DefaultAttributeContainer.Builder createGiraffeEntityAttributes() {
