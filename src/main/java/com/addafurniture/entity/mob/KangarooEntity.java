...
public class KangarooEntity extends AnimalEntity {
    public KangarooEntity(EntityType<? extends AnimalEntity> type, World world) { super(type, world); }
    public static DefaultAttributeContainer.Builder createKangarooEntityAttributes() {
