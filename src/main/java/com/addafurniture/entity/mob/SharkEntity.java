...
public class SharkEntity extends AnimalEntity {
    public SharkEntity(EntityType<? extends AnimalEntity> type, World world) { super(type, world); }
    public static DefaultAttributeContainer.Builder createSharkEntityAttributes() {
